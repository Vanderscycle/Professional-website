...
<footer>
	<div class="dark:text-darkBlack dark:bg-darkGui text-Bg bg-Gui fixed inset-x-0 bottom-0 text-center inline-flex items-center">
      ...
      <div class="p-1 inline-flex">
  		<a href="https://github.com/Vanderscycle" target="_blank" rel="noopener noreferrer">
  		...
  		<a href="mailto:henri-vandersleyen@protonmail.com" target="_blank" rel="noopener noreferrer">
  			<svg class="w-6 h-6" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
